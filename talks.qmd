...
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('details.year').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('details.year').forEach(d => d.open = false)" style="margin-left: .5rem;">Collapse all</button>
</div>
<details class="year" markdown="1">
