...
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-presentations').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-presentations').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
(texts and slides available on request)

## 2025
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2025').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2025').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2024
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2024').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2024').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2023
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2023').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2023').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2022
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2022').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2022').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2020
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2020').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2020').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2019
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2019').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2019').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2018
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2018').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2018').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2017
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2017').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2017').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2016
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2016').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2016').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2015
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2015').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2015').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2014
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2014').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2014').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2013
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2013').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2013').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2012
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2012').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2012').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2011
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2011').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2011').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2010
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2010').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2010').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2009
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2009').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2009').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2008
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2008').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2008').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
## 2007
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-2007').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-2007').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
...
<div style="margin: 1rem 0;">
  <button type="button" onclick="document.querySelectorAll('.year.section-organisation-and-hosting').forEach(d => d.open = true)">Expand all</button>
  <button type="button" onclick="document.querySelectorAll('.year.section-organisation-and-hosting').forEach(d => d.open = false)" style="margin-left:.5rem;">Collapse all</button>
</div>
