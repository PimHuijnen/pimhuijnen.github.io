...
2026 \| Seed money grant from the [Descartes Centre](https://www.uu.nl/en/descartes-centre){.external target="_blank"} for 'A hidden universe of uncertainty': building a network around a ‘many analysts study’ in history (as co-PI; 4,800€)

2024 \| Grant from the UU Education Incentive Fund for Transferable pedagogies for an Open Science mindset and skillset (as contributor; 250,000€)

2023 \| Seed money grant from the [UU Aplied Data Science focus Area](https://www.uu.nl/en/research/ai-data-science){.external target="_blank"} for Finding Sentiments in Factual Texts: Evaluation of Approaches for Analyzing Sentiments in Historical Newspapers (as co-PI; 7,500€)
...
Since 2026 \| Member of the steering board of [SSHOC-NL](https://sshoc.nl/){.external target="_blank"}
...
Since 2018 \| Reviewer for, amongst others, *Tijdschrift voor Geschiedenis*, *BMGN-Low Countries Historical Review*, *Digital Scholarship in the Humanities*, *Social History of Medicine*, *Historical Methods: A Journal of Quantitative and Interdisciplinary History*, *Endeavor*

2023, 2026 \| Member of the Dutch Research Council ([NWO](https://www.nwo.nl/en){.external target="_blank"}) VENI funding scheme review committee

2023-2025 \| Member of the national advisory committee national [Thematic Digital Competence Centre Social Sciences and Humanities (SSH)](https://tdcc.nl/about-tddc/ssh/){.external target="_blank"}
